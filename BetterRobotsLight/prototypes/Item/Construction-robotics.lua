data:extend({
	{
		...
		place_result = "BRL-construction-robotics-mk1",
		stack_size = 100,
		weight = 20 * kg
	},
	{
		...
		subgroup = "ConstructionRobotics",
		order = "a[robot]-bb[construction-robot]",
		place_result = "BRL-construction-robotics-mk2",
		stack_size = 100,
		weight = 20 * kg
	},
	{
		...
		place_result = "BRL-construction-robotics-mk3",
		stack_size = 100,
		weight = 20 * kg
	},
	{
		...
		place_result = "BRL-construction-robotics-mk4",
		stack_size = 100,
		weight = 20 * kg
	},
	{
		...
		place_result = "BRL-construction-robotics-mk5",
		stack_size = 100,
		weight = 20 * kg
	}
})
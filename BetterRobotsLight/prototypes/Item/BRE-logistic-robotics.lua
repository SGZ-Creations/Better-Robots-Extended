data:extend({
	...
	},
	{
		...
		subgroup = "LogisticRobotics",
		order = "a[robot]-ab[logistic-robot]",
		place_result = "BRE-logistic-robotics-mk2",
		stack_size = 100,
		weight = 20 * kg
	},
	{
		...
		place_result = "BRE-logistic-robotics-mk3",
		stack_size = 100,
		weight = 20 * kg
	},
	{
		...
		place_result = "BRE-logistic-robotics-mk4",
		stack_size = 100,
		weight = 20 * kg
	},
	{
		...
		place_result = "BRE-logistic-robotics-mk5",
		stack_size = 100,
		weight = 20 * kg
	}
})